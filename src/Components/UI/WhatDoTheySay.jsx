...
const WhatDoTheySay = () => {
  return (
    <section className="bg-[#F8F8F8]">
      <Container>
        {/* Main Div */}
        <div className="py-[87px] flex flex-col items-center">
          {/* Heading */}
          <div className="flex flex-col items-center">
            <h1 className="text-[#2C2C2C] text-[36px] font-poppins font-semibold leading-[54px]">
              What do they <span className="text-[#CC8663]">say?</span>
            </h1>
            <p className="text-[#808080] text-base font-poppins font-normal leading-9">
              This is an honest review from members who have joined us
            </p>
          </div>

          {/* Testimonial Div */}
          <div className="pt-[50px] flex justify-center items-center gap-[20px]">
            <TestimonialCart />
            <TestimonialCart />
            <TestimonialCart />
          </div>
